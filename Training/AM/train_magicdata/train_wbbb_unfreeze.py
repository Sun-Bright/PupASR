# ======= train_wbbb_unfreeze.py（解冻 encoder，继续训练，支持断点续训）=======
...
class MemoryManagementCallback(TrainerCallback):
    ...
    def on_step_end(self, args, state, control, logs=None, **kwargs):
        ...
        if self.log_memory and state.global_step % 500 == 0:
            ...
            print(f"[] GPU 内存: {torch.cuda.memory_allocated() / 1024 / 1024:.2f} MB")
...
def main():
    ...
    MODEL_PATH = "./saved_chinese_model_wbbb_stable/checkpoint-5000"
    DATASET_PATH = "/mnt/data/preprocessed_magicdata_wbbb_fixed"
    OUTPUT_DIR = "./saved_chinese_model_wbbb_unfreeze"
    ...
    if os.path.exists(OUTPUT_DIR):
        ...
        if checkpoints:
            ...
            resume_checkpoint = os.path.join(OUTPUT_DIR, last_ckpt)
            print(f"[] 检测到已有 checkpoint: {resume_checkpoint}，将从该点继续训练")
