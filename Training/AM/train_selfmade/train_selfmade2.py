...
# === 配置路径 ===
PRETRAINED_MODEL = "./my_model/finetune_cpu_output/checkpoint-348"
TRAIN_TXT = "./record2/txt/split/train.txt"
DEV_TXT = "./record2/txt/split/dev.txt"
OUTPUT_DIR = "./my_model/final_stage2_output"
SAMPLE_RATE = 16000
...
for param in model.wav2vec2.encoder.layers[-3:].parameters():
...
def compute_metrics(pred: EvalPrediction):
    ...
    print("="*80 + "\n")
    return {"eval_cer": cer_avg, "cer": cer_avg}
    ...
    def on_evaluate(self, args, state, control, metrics, **kwargs):
        ...
        with open(log_path, "a", encoding="utf-8") as f:
            log_line = {
                ...
                "eval_cer": metrics.get("eval_cer", metrics.get("cer")),
